...
export async function getAllUsers(
    ...
    try {
        ...
        if (sortBy && sortOrder) {
            allUsers.sort((a, b) => {
                let valueA: string | number | Date | null = a[sortBy as keyof UserWithoutPassword] as string | number | Date | null;
                let valueB: string | number | Date | null = b[sortBy as keyof UserWithoutPassword] as string | number | Date | null;
